 ...
 */
import GlutenblocksCarouselBlockEdit from '../edit';
import GlutenblocksCarouselBlockSave from '../save';
...
describe('carousel-block', () => {
    describe('edit', () => {
        it('should render without crashing', () => {
            const wrapper = shallow(
                <GlutenblocksCarouselBlockEdit attributes={attributes}/>
            );
    ...
    describe('save', () => {
        it('should render without crashing', () => {
            const wrapper = shallow(
                <GlutenblocksCarouselBlockSave attributes={attributes}/>
            );
            expect(wrapper).toBeTruthy();
        });
    });
